...
export const VOCABULARY_DEFAULT = {
  ...
  sentences: [
    ...
    { key: 'translation-h2', value: 'Write or pronounce the sentence to translate' },
...
export const VOCABULARY_V2 = [
  {
    ...
    sentences: [
      ...
      { key: 'translation-h2', value: 'כתוב או הגה את המשפט לתרגום' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'translation-h2', value: 'اكتب أو انطق الجملة لترجمتها' },
      ...
      { key: 'rate-understand', value: 'هل تسمح لك هذه الأداة بالحوار بسهولة مع المحاور؟' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'listen', value: 'استمع' },
      { key: 'record-text', value: 'تكلم الان' },
      { key: 'languageButtonRAW', value: 'اللغة العربية' },
      { key: 'languageButtonFR', value: 'langue arabe' },
      { key: 'readed-welcome', value: 'هل ترغب في التبادل بهذه اللغة؟' },
      { key: 'rate-easyToUse', value: 'هل هذه الأداة سهلة الاستخدام؟' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'translation-h2', value: 'جمله را برای ترجمه بنویسید یا تلفظ کنید' },
      { key: 'rate', value: 'آیا از مصاحبه خود راضی هستید؟' },
      { key: 'thanks', value: 'Pôle Emploi از شما متشکرم' },
      { key: 'listen', value: 'گوش دادن' },
      { key: 'languageButtonRAW', value: 'زبان فارسی' },
      { key: 'languageButtonFR', value: 'langue persane' },
      ...
      { key: 'rate-understand', value: 'آیا این ابزار به شما امکان می دهد تا به راحتی با گفتگوی خود گفتگو کنید؟' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'translation-h2', value: 'Ecrire ou prononcer la phrase à traduire' },
      ...
      { key: 'rate-understand', value: 'Est-ce que cet outil vous a permis de dialoguer facilement avec votre interlocuteur ?' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
      { key: 'languageButtonRAW', value: 'English language' },
      { key: 'languageButtonFR', value: 'Langue anglaise' },
      ...
      { key: 'rate-understand', value: 'Did this tool allow you to easily dialogue with your interlocutor?' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'languageButtonRAW', value: 'Idioma español' },
      { key: 'languageButtonFR', value: 'langue espagnole' },
      { key: 'translation-h2', value: 'Escribe o pronuncia la oración para traducir' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'translation-h2', value: '写下或发音要翻译的句子' },
      { key: 'rate', value: '您對面試滿意嗎？' },
      { key: 'thanks', value: 'PôleEmploi謝謝' },
      { key: 'listen', value: '聽' },
      { key: 'languageButtonRAW', value: '普通话' },
      { key: 'languageButtonFR', value: 'langue mandarin' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'translation-h2', value: 'অনুবাদ করতে বাক্যটি লিখুন বা উচ্চারণ করুন' },
      { key: 'rate', value: 'আপনি কি আপনার সাক্ষাত্কারে সন্তুষ্ট?' },
      { key: 'thanks', value: 'পোলে কর্মচারী আপনাকে ধন্যবাদ' },
      { key: 'listen', value: 'শোনা' },
      { key: 'languageButtonRAW', value: 'বেঙ্গালি ভাষা' },
      { key: 'languageButtonFR', value: 'langue bengali' },
      ...
      { key: 'rate-understand', value: 'এই সরঞ্জামটি কি আপনাকে সহজেই আপনার কথোপকথকের সাথে কথোপকথনের অনুমতি দেয়?' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'translation-h2', value: 'د ژباړې لپاره جمله ولیکئ یا تلفظ کړئ' },
      ...
      { key: 'rate-understand', value: 'ایا دا وسیله تاسو ته اجازه درکوي چې په اسانۍ سره د خپل خبرو اترو سره خبرو اترو ته ورشئ؟' },
      { key: 'rate-comment', value: 'وړیا نظر' },
      { key: 'gauge-text', value: 'Speak now' },
      { key: 'auto-listen', value: 'پخپله غوږ شه' },
      { key: 'languageButtonRAW', value: 'پښتو ژبه' },
      { key: 'languageButtonFR', value: 'langue pachto' },
    ],
  },
  {
    isoCode: 'ur-PK',
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'ترجمہ کرنے کے لئے جملہ لکھیں یا اس کا تلفظ کریں' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'Escreva ou pronuncie a frase para traduzir' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
      ...
      { key: 'languageButtonRAW', value: 'Língua portuguesa' },
      { key: 'languageButtonFR', value: 'langue portugaise' },
    ],
  },
  {
    isoCode: 'tr-TR',
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'Çevrilecek cümleyi yazın veya telaffuz edin' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'Schreiben oder sprechen Sie den zu übersetzenden Satz aus' },
      { key: 'languageButtonRAW', value: 'Deutsche Sprache' },
      { key: 'languageButtonFR', value: 'langue allemande' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
      { key: 'gauge-text', value: 'Speak now' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'ለመተርጎም ዓረፍተ ነገሩን ይፃፉ ወይም ይናገሩ' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'សរសេរឬប្រកាសប្រយោគដើម្បីបកប្រែ' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'अनुवाद करने के लिए वाक्य लिखें या उच्चारण करें' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'மொழிபெயர்க்க வாக்கியத்தை எழுதவும் அல்லது உச்சரிக்கவும்' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'Scrivi o pronuncia la frase da tradurre' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'languageButtonRAW', value: 'Lingua italiana' },
      { key: 'languageButtonFR', value: 'langue italienne' },
      { key: 'listen', value: 'Listen' },
      { key: 'gauge-text', value: 'Speak now' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'Орчуулах өгүүлбэрийг бичих эсвэл хэлэх' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'अनुवाद गर्न वाक्य लेख्नुहोस् वा उच्चारण गर्नुहोस्' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'translation-h2', value: 'Напишите или произнесите предложение для перевода' },
      ...
      { key: 'languageButtonRAW', value: 'Русский язык' },
      { key: 'languageButtonFR', value: 'langue russe' },
    ],
  },
  {
    isoCode: 'uz-UZ',
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'Tarjima qilish uchun jumlalarni yozing yoki yozing' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'Scrieți sau pronunțați propoziția de tradus' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'Qoraal ama ku dhawaaq jumladda si aad u tarjunto' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
  ...
  },
  {
    ...
    sentences: [
      ...
      { key: 'send', value: 'Send' },
      { key: 'translate', value: 'Translate' },
      { key: 'translation-h2', value: 'Viết hoặc phát âm câu để dịch' },
      { key: 'rate', value: 'Are you satisfied with your interview?' },
      { key: 'thanks', value: 'Pôle Emploi thanks you.' },
      { key: 'listen', value: 'Listen' },
