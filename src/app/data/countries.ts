export const COUNTRIES: { country: string; LanguageFr: string; flag: string; traduction: string; code: { audioLanguage: string; writtenLanguage: string }; language: string }[] = [
  {
    country: 'Suid-Afrika',
